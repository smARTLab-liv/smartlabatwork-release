...
SlawBatteryMonitor::SlawBatteryMonitor(ros::NodeHandle n)
{
    ...
    pub_battery_status_ = nh_.advertise<slaw_msgs::BatteryStatus>("dashboard/battery_status", 1);
...
void SlawBatteryMonitor::cb_sysinfo(const slaw_msgs::SysInfo::ConstPtr& msg) {
