...
#include <ros/ros.h>
#include <slaw_msgs/BatteryStatus.h>
#include <slaw_msgs/SysInfo.h>
...
public:
	...
	void cb_sysinfo(const slaw_msgs::SysInfo::ConstPtr& msg);
...
private:
	...
	slaw_msgs::BatteryStatus battery_message_;
