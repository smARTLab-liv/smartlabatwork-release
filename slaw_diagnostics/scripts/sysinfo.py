#!/usr/bin/env python
import rospy
from slaw_msgs.msg import SysInfo, SystemStatus, NetworkStatus, BatteryStatus
...
class SystemInfo():
    ...
    def __init__(self):
        ...
        try:
            ...
            rospy.loginfo("sysinfo could not get hostname")
            print "sysinfo could not get hostname"
        ...
        while not rospy.is_shutdown():
            ...
            #except:
            #    print "could not send sysinfo msg"
...
if __name__ == '__main__':
    try:
        #rospy.loginfo("sysinfo starting")
        #print ("sysinfo starting print")
        obj = SystemInfo()
        #print "sysinfo died"
    except rospy.ROSInterruptException as e:
        print "sysinfo died", str(e)
        #    rospy.logerr("sysinfo failed to start", str(e))
        #    pass
